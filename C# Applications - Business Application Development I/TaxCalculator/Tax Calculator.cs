...
namespace TaxCalculator
{
    public partial class Form1 : Form
    {
        ...
        private decimal CalculateTax(decimal incomeamount)
        {
            ...
            else
            {
                ...
                else if (TaxableIncome > 37450 && TaxableIncome <= 90750)
                {
                    ...
                    //return txtTaxOwed.Text = Convert.ToString(TaxOwed);
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            TaxOwed = CalculateTax(TaxableIncome);
            txtTaxOwed.Text = Convert.ToString(TaxOwed); //calls the tax owed fucntion and returns a decimal value... then sets the taxowed.
